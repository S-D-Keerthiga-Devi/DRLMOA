...
# Original imports that might need adaptation for deployment
try:
    from sklearn.manifold import TSNE  # For t-SNE visualization
except ImportError:
    st.warning("sklearn.manifold TSNE not available, some visualizations may be limited")

try:
    from mpl_toolkits.mplot3d import Axes3D  # For 3D visualization
except ImportError:
    st.warning("mpl_toolkits.mplot3d Axes3D not available, 3D visualizations will be limited")
